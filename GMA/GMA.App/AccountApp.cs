...
public class AccountApp
{
    ...
    public static string patternPassword = @"^.{3,100}$";
    ...
    public static void ViewProfileMenu()
    {
        ...
        AnsiConsole.Write(table);
        Console.Write("Press Any Key To Back To Account Menu! ");
        Console.ReadKey();
    }
    ...
    public static void CheckPassToAddFunds(int choice)
    {
        ...
        {
            double currentMoney = accountLoggedIn.Money;
            switch (choice)
            {
                case 1:
            ...
            {
                Console.Write($"Your Wallet Add Funds Successfully with {HandlingString.FormatCurrencyVND(accountLoggedIn.Money - currentMoney)}! ");
                Console.ReadKey();
            }
    ...
    public static string GetAccountRegister(string text)
    {
        while (true)
        {
            ...
            {
                isValid = false;
                Console.Write($"{text} Cannot Be Empty! ");
                Console.ReadKey();
            }
            else
            {
                ...
                else
                {
                    ...
                    else if (text == "Password")
                    {
                        ...
                        {
                            isValid = false;
                            Console.Write("The Password Must Has A Length Between 3 And 100 Characters");
                            Console.ReadKey();
                        }
                    }
