...
public class OrderDAL
{
    ...
    private Order Get(MySqlDataReader reader)
    {
        ...
        order.OrderId = reader.GetInt16("id");
        order.OrderAccount = new Account(reader.GetInt16("account_id"));
        order.TotalPrice = reader.GetDouble("totalprice");
        order.CreatedAt = reader.GetDateTime("created_at");
        order.Status = reader.GetInt16("status");
